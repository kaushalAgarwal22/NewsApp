...
class TenFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view:View = inflater.inflate(R.layout.fragment_ten, container, false)

        mServiceSource =Common.newsSourceService
        layoutManager= LinearLayoutManager(activity)
        view.rvTenth.layoutManager=layoutManager
    ...
    private fun loadNewsSource() {
        ...
        mServiceSource.source_canada.enqueue(object : retrofit2.Callback<NewsResponse> {
