...
import kotlinx.android.synthetic.main.fragment_nineth.*
import kotlinx.android.synthetic.main.fragment_nineth.view.*
...
class NinethFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_nineth, container, false)

        mServiceSource =Common.newsSourceService
        layoutManager= LinearLayoutManager(activity)
        view.rvNine.layoutManager=layoutManager
    ...
    private fun loadNewsSource() {
        ...
        mServiceSource.source_australia.enqueue(object : retrofit2.Callback<NewsResponse> {
