...
import kotlinx.android.synthetic.main.fragment_seventh.view.*
...
class SeventhFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view:View =inflater.inflate(R.layout.fragment_seventh, container, false)

        mServiceSource =Common.newsSourceService
        layoutManager= LinearLayoutManager(activity)
        view.rvSeventh.layoutManager=layoutManager
    ...
    private fun loadNewsSource() {
        ...
        mServiceSource.source_usa.enqueue(object : retrofit2.Callback<NewsResponse> {
